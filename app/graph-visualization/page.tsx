...
//     const input = document.getElementById(`${chartType}-chart`);
//     const canvas = await html2canvas(input);
//     const imgData = canvas.toDataURL('image/png');
//     const pdf = new jsPDF();

//     pdf.addImage(imgData, 'PNG', 0, 0);
//     pdf.text(`Data for ${chartType.charAt(0).toUpperCase() + chartType.slice(1)}:`, 10, 150);
    
//     const dataValues = chartType === 'temperature' ? temperatureData : humidityData;
//     const dataLabels = labels;

//     dataLabels.forEach((label, index) => {
//       pdf.text(`${label}: ${dataValues[index]}`, 10, 160 + (index * 10));
//     });
...
//       <div id="charts-container" className="mb-8">
//         <h2 className="text-xl font-semibold mb-4 text-gray-800 text-center">Temperature Over Time</h2>
//         <div id="temperature-chart" className="w-full h-64 overflow-x-auto">
//           <Line data={temperatureChartData} options={{
//             responsive: true,
//             maintainAspectRatio: false,
//             scales: {
...
//             },
//           }} />
//           <button onClick={() => downloadChartAsPDF('temperature')} className="mt-4 bg-blue-500 text-white px-4 py-2 rounded">
//             Download Temperature Report
//           </button>
//         </div>

//         <h2 className="text-xl font-semibold mb-4 text-gray-800 text-center">Humidity Over Time</h2>
//         <div id="humidity-chart" className="w-full h-64 overflow-x-auto">
//           <Line data={humidityChartData} options={{
//             responsive: true,
//             maintainAspectRatio: false,
//             scales: {
...
//             },
//           }} />
//           <button onClick={() => downloadChartAsPDF('humidity')} className="mt-4 bg-blue-500 text-white px-4 py-2 rounded">
//             Download Humidity Report
//           </button>
//         </div>

//         <h2 className="text-xl font-semibold mb-4 text-gray-800 text-center">Temperature and Humidity Bar Chart</h2>
//         <div id="bar-chart" className="w-full h-64 overflow-x-auto">
//           <Bar data={barChartData} options={{
//             responsive: true,
//             maintainAspectRatio: false,
//             scales: {
...
//             },
//           }} />
//           <button onClick={() => downloadChartAsPDF('bar')} className="mt-4 bg-blue-500 text-white px-4 py-2 rounded">
