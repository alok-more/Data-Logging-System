...
//                   fill="currentColor"
//                   d="M4 12a8 8 0 018-8v5l4-4-4-4v5a8 8 0 01-8 8z"
//                 />
//               </svg>
//             </div>
//           )}
...
//                 <p
//                   className={`text-5xl md:text-6xl font-bold text-blue-600 text-center transition-transform 
...
//                 <p
//                   className={`text-5xl md:text-6xl font-bold text-green-600 text-center transition-transform 
